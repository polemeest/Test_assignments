...
class Product(models.Model):
    ...
    name = models.CharField(verbose_name='название_продукта', max_length=75,  # Явное лучше чем неявное
                            null=False, blank=False, unique=True)
    used = models.PositiveBigIntegerField(verbose_name='популярность',
...
class Recipe(models.Model):
    ...
    class Meta:
        ''' Прописанные имена для панели администратора и ограничение на уникальное поле. '''
        verbose_name = "Рецепт"
